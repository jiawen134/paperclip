...
const inboxIssueColumnLabelKeys: Record<InboxIssueColumn, string> = {
  ...
  labels: "columnTags",
  updated: "columnLastUpdated",
};
const inboxIssueColumnDescriptionKeys: Record<InboxIssueColumn, string> = {
  status: "columnStatusDesc",
  id: "columnIdDesc",
  assignee: "columnAssigneeDesc",
  project: "columnProjectDesc",
  workspace: "columnWorkspaceDesc",
  labels: "columnTagsDesc",
  updated: "columnLastUpdatedDesc",
};
          ...
          <span className="min-w-0 flex-1">
            <span className="line-clamp-2 text-sm font-medium sm:truncate sm:line-clamp-none">
              {issue ? (
                ...
                <>{linkedAgentName ? t("failedRunAgent", { name: linkedAgentName }) : t("failedRun")}</>
              )}
            </span>
      ...
      <div className="flex items-start gap-2 sm:items-center">
        ...
        <div className="flex min-w-0 flex-1 items-start gap-2">
          ...
          <span className="min-w-0 flex-1">
            ...
            <span className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-muted-foreground">
              <span>{t("requestedFromIp", { time: timeAgo(joinRequest.createdAt), ip: joinRequest.requestIp })}</span>
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-2">
          ...
          {canMarkAllRead && (
            <>
              ...
              >
                {markAllReadMutation.isPending ? t("marking") : t("markAllAsRead")}
              </Button>
              <Dialog open={showMarkAllReadConfirm} onOpenChange={setShowMarkAllReadConfirm}>
                <DialogContent className="sm:max-w-md">
                  <DialogHeader>
                    <DialogTitle>{t("markAllAsReadConfirm")}</DialogTitle>
                    <DialogDescription>
      ...
      {tab === "all" && (
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="everything">{t("allCategories")}</SelectItem>
              <SelectItem value="issues_i_touched">{t("myRecentIssues")}</SelectItem>
              <SelectItem value="join_requests">{t("joinRequests")}</SelectItem>
              <SelectItem value="approvals">{t("approvals")}</SelectItem>
              <SelectItem value="failed_runs">{t("failedRuns")}</SelectItem>
          ...
          {showApprovalsCategory && (
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="actionable">{t("needsAction")}</SelectItem>
      ...
      {allLoaded && visibleSections.length === 0 && (
        <EmptyState
          ...
          message={
            searchQuery.trim()
              ? t("noInboxSearchResults")
              : tab === "mine"
              ? t("inboxZero")
              : tab === "unread"
              ? t("noNewInboxItems")
              : tab === "recent"
                ? t("noRecentInboxItems")
                : t("noInboxFilterResults")
          }
        />
      )}
